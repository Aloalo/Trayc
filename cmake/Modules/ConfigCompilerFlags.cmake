...
if(OPTIX_USE_AGGRESSIVE_WARNINGS)
  SET(CXX_WARNING_FLAGS "-Wall -Werror -Wsign-compare -Wno-multichar")
...
SET(RELEASE_FLAGS "-O3 -DNDEBUG -g3 -funroll-loops -ffast-math")
...
if(OPTIX_USE_AGGRESSIVE_WARNINGS)
  set(WARNING_FLAGS "/WX /wd4355 /wd4996 /w34101 /w34189 /w34018 /w34389")
else()
